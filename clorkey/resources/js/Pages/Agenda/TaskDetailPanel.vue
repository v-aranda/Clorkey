...
<template>
    <Teleport to="body">
        <div v-if="show" class="fixed inset-0 z-50">
            ...
            <div class="fixed inset-y-0 right-0 z-50 flex w-full max-w-lg flex-col border-l bg-white shadow-xl">

                <!-- Header -->
                <div class="flex items-start justify-between border-b px-6 py-4">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wide text-gray-400">{{ formatDateLabel(task?.date) }}</p>
                ...
                <div class="flex-1 flex flex-col min-h-0">
                    ...
                    <template v-if="detailViewTab === 'chat'">
                        <div class="flex-1 min-h-0">
                            ...
                            />
                            <div v-else class="flex items-center justify-center h-full text-sm text-gray-400">Selecione uma tarefa para ver o chat.</div>
                        </div>
                    ...
                    <div v-else class="flex-1 overflow-y-auto px-6 py-6">
                        <div v-if="task?.description" class="prose prose-sm max-w-none text-gray-700" v-html="task.description"></div>
