...
<template>
    <div class="flex items-center gap-3 border-b border-gray-50 px-4 py-3 transition-colors last:border-b-0 hover:bg-gray-50">
        <!-- LEFT SIDE: Drag handle + Action buttons -->
        <div class="flex shrink-0 items-center gap-1.5">
            <!-- Drag handle -->
            <div class="drag-handle cursor-grab text-gray-300 transition-colors hover:text-gray-500 active:cursor-grabbing">
